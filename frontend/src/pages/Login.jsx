...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#0f3d4a] flex items-center justify-center p-6">
      <div className="flex w-full max-w-4xl rounded-3xl overflow-hidden shadow-2xl" style={{ minHeight: "520px" }}>
        ...
        <div className="flex-1 bg-white flex flex-col justify-center px-10 py-12 relative">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button className="w-full bg-[#0f3d4a] text-white py-3 rounded-lg text-sm font-semibold hover:bg-[#0a2d38] transition mt-2">
              Login
            </button>
          </form>
          ...
          <p className="text-xs text-gray-400 mt-5">
            ...
            <Link to="/signup" className="text-[#0f3d4a] font-semibold">
              Sign Up
            </Link>
          </p>
        </div>
